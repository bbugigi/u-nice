...
const App = (() => {
  ...
  const Products = (() => {
    ...
    const renderCarousels = async () => {
      ...
      const cats = { cardiovascular:'cardiovascularCarousel', cellular:'cellularCarousel', skeletal:'skeletalCarousel', neurological:'neurologicalCarousel' };
